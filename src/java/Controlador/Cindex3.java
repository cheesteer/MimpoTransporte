...
import objetos.TransporteObjecto;

/**
 *
 * @author Lenovo
 */
public class Cindex3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Cindex3</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Cindex3 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
...
//        response.getWriter().write("RECIBIDO EN EL CONTROLER" + toJson);
    ...
    public Date obtenerFecha(String d) {
